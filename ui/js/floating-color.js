 ...
 */
export function renderColorSuggestion(color, container, currentMatches, onCopy, onPickerChange, resizeWindow) {
    container.innerHTML = '';
    ...
    pickerInput.style.cssText = 'position:absolute;top:0;left:0;width:100%;height:100%;opacity:0;cursor:pointer;';
