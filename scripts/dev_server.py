...
MOCK_CATALOG = [
    ...
    {"id": "color-picker", "name": "Color Picker", "type": "extension", "version": "1.0.0", "author": "kiro-assistant", "description": "Detect and preview colors (hex, rgb, hsl, named) with format conversion.", "icon": "🎨", "tags": ["color", "design", "utility", "hex", "rgb"]},
    {"id": "dev-tools", "name": "Developer Tools", "type": "extension", "version": "1.0.0", "author": "kiro-assistant", "description": "UUID generation, base64 encode/decode, hashing, epoch conversion, JSON formatting.", "icon": "🔧", "tags": ["developer", "uuid", "base64", "hash", "json", "utility"]},
    {"id": "timer", "name": "Timer & Stopwatch", "type": "extension", "version": "1.0.0", "author": "kiro-assistant", "description": "Countdown timer and stopwatch with notification sounds.", "icon": "⏱️", "tags": ["timer", "stopwatch", "productivity", "pomodoro"]},
    {"id": "todos", "name": "Todos & Reminders", "type": "extension", "version": "1.0.0", "author": "kiro-assistant", "description": "Task manager with due dates, categories, priorities, and progress tracking. Type 'todo' for a summary, 'todo+ <task>' to add, 'todo+ <task> due:<date>' for a reminder with a due-date banner.", "icon": "✅", "tags": ["productivity", "tasks", "todo", "organizer", "reminders"]},
    {"id": "dictionary", "name": "Dictionary", "type": "extension", "version": "1.7.2", "author": "kiro-assistant", "description": "Look up word definitions, spelling corrections, and pronunciation. Supports 250+ languages via FreeDictionaryAPI.com.", "icon": "📖", "tags": ["dictionary", "spelling", "definitions", "language", "words", "translate"]},
    {"id": "focus-tracker", "name": "Focus Tracker", "type": "extension", "version": "1.3.2", "author": "kiro-assistant", "description": "Track app usage, context switches, and focus streaks. Get daily/weekly/monthly reports with AI insights.", "icon": "📊", "tags": ["focus", "productivity", "screen time", "activity", "tracker", "heatmap"]},
