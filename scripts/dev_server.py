...
MOCK_CATALOG = [
    ...
    {"id": "todos", "name": "Todos", "type": "extension", "version": "0.1.0", "author": "kiro-assistant", "description": "Task manager with due dates, categories, priorities, and progress tracking. Type 'todos' to view your list or 'todo! <task>' to quick-add.", "icon": "✅", "tags": ["productivity", "tasks", "todo", "organizer"]},
]
