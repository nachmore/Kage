...
MOCK_CATALOG = [
    ...
    {"id": "todos", "name": "Todos", "type": "extension", "version": "0.5.0", "author": "kiro-assistant", "description": "Task manager with due dates, categories, priorities, and progress tracking. Type 'todo' for a summary, 'todo+' to add, 'todo-' to remove.", "icon": "✅", "tags": ["productivity", "tasks", "todo", "organizer"]},
]
