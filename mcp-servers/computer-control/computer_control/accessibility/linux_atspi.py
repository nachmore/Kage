"""Linux AT-SPI2 provider (D-Bus accessibility). Stub — not yet implemented."""
...
class LinuxATSPIProvider(AccessibilityProvider):
    """Linux AT-SPI2 provider — requires pyatspi2."""

    def __init__(self):
        raise NotImplementedError(
            "Linux AT-SPI2 accessibility provider not yet implemented. "
